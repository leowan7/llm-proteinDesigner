...
Generates three export formats from a completed job's analysis data:
  - PDF  (fpdf2, Kendrew branding, text and tables only per D-16)
...
class KendrewReport(FPDF):
    """FPDF subclass with Kendrew-branded header and footer.
    ...
    def header(self):
        """Render Kendrew page header with report title."""
        self.set_font("Helvetica", "B", 14)
        self.set_text_color(30, 30, 30)
        self.cell(0, 10, "Kendrew Design Analysis Report", align="C", new_x="LMARGIN", new_y="NEXT")
    ...
    def footer(self):
        ...
        self.cell(0, 10, f"Generated by Kendrew  |  Page {self.page_no()}  |  Download links expire in 24 hours.", align="C")
...
def generate_pdf_report(
    ...
    """Generate a Kendrew-branded PDF analysis report.
